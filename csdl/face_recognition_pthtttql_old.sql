...
--
-- Host: localhost
-- Generation Time: Jun 27, 2020 at 01:08 PM
...
INSERT INTO `ClassSection` (`sectionID`, `subjectID`, `roomID`, `weekDay`, `startSlot`, `teacherID`, `numberOfStudents`, `attendanceStatus`) VALUES
(1, 1, 1, '18/25/2020', 7, 3, 6, 1),
(2, 1, 1, '30/6/2020', 7, 3, 6, 0),
(3, 1, 1, '30/06/2020', 11, 3, 6, 0),
(4, 2, 2, '30/06/2020', 1, 3, 4, 0);
...
ALTER TABLE `ClassSection`
  ...
  ADD CONSTRAINT `ClassSection_ibfk_4` FOREIGN KEY (`subjectID`) REFERENCES `Subject` (`subjectID`);
